...
import com.example.authentication.exceptions.UnauthorizedUserException;
...
import com.example.authentication.security.SecurityUtil;
import com.example.authentication.mapper.RegisterRequestDTOUserMapper;
...
public class AuthenticationServiceImpl implements AuthenticationService {
     ...
     public AuthenticationResponseDTO register(RegisterRequestDTO request) {
          ...
          User user = User.builder()
                    ...
                    .oauthProvider("local")
                    .emailVerified(true) // Set to true for local users since email verification is not implemented
                    .isActive(true)
                    .build();
